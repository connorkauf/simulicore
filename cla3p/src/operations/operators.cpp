...
cla3p::dns::RiVector operator*(cla3p::dns::RiMatrix& srcA, const cla3p::dns::RiVector& srcX) { return cla3p::ops::matvec_mult(noOp, 1, srcA, srcX); }
cla3p::dns::RdVector operator*(cla3p::dns::RdMatrix& srcA, const cla3p::dns::RdVector& srcX) { return cla3p::ops::matvec_mult(noOp, 1, srcA, srcX); }
cla3p::dns::RfVector operator*(cla3p::dns::RfMatrix& srcA, const cla3p::dns::RfVector& srcX) { return cla3p::ops::matvec_mult(noOp, 1, srcA, srcX); }
cla3p::dns::CdVector operator*(cla3p::dns::CdMatrix& srcA, const cla3p::dns::CdVector& srcX) { return cla3p::ops::matvec_mult(noOp, 1, srcA, srcX); }
cla3p::dns::CfVector operator*(cla3p::dns::CfMatrix& srcA, const cla3p::dns::CfVector& srcX) { return cla3p::ops::matvec_mult(noOp, 1, srcA, srcX); }
