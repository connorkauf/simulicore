...
/*-------------------------------------------------*/
void omatcopy(char ordering, char trans, size_t rows, size_t cols,
    real4_t alpha, const real4_t *a, size_t lda, real4_t *b, size_t ldb)
{
...
/*-------------------------------------------------*/
void omatcopy(char ordering, char trans, size_t rows, size_t cols,
		complex8_t alpha, const complex8_t *a, size_t lda, complex8_t *b, size_t ldb)
{
...
/*-------------------------------------------------*/
void imatcopy(char ordering, char trans, size_t rows, size_t cols,
    real4_t alpha, real4_t *a, size_t lda, size_t ldb)
{
...
/*-------------------------------------------------*/
void imatcopy(char ordering, char trans, size_t rows, size_t cols,
    complex8_t alpha, complex8_t *a, size_t lda, size_t ldb)
{
