...
int main()
{
	...
	{
		/*
		 * Permute A from the left side using operators and the permute member function respectively
		 */
	...
	{
		/*
		 * Permute A from the right side using operators and the permute member function respectively
		 */
	...
	{
		/*
		 * Permute A from both sides using operators and the permute member function respectively
		 */
