 ...
 */
template <typename T_Scalar, typename T_Vector>
class XxVector2 : public XxObject2<T_Scalar,T_Vector> {
	...
	public:
		...
		// no copy
		XxVector2(const XxVector2<T_Scalar,T_Vector>&) = delete;
		XxVector2<T_Scalar,T_Vector>& operator=(const XxVector2<T_Scalar,T_Vector>&) = delete;
		 ...
		 */
		XxVector2(XxVector2<T_Scalar,T_Vector>&& other) = default;
		 ...
		 */
		XxVector2<T_Scalar,T_Vector>& operator=(XxVector2<T_Scalar,T_Vector>&& other) = default;
		...
		/**
		 * @copydoc cla3p::dns::XxVector2::operator()(uint_t i)
		 */
		const T_Scalar& operator()(uint_t i) const;
		 ...
		 * @param[in] src The vector to be placed.
		 */
		void setBlock(uint_t ibgn, const XxVector2<T_Scalar,T_Vector>& src);
