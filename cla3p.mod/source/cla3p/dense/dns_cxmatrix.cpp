...
namespace cla3p {
/*-------------------------------------------------*/
template<> std::string BasicTypeTraits<dns::CxMatrix<complex_t>>::type_name() { return stringDenseMatrix(); }
template<> std::string BasicTypeTraits<dns::CxMatrix<complex8_t>>::type_name() { return stringDenseMatrix(); }
/*-------------------------------------------------*/
} // namespace cla3p
/*-------------------------------------------------*/
