...
namespace cla3p {
/*-------------------------------------------------*/
template<> std::string BasicTypeTraits<dns::CxVector<complex_t>>::type_name() { return stringDenseVector(); }
template<> std::string BasicTypeTraits<dns::CxVector<complex8_t>>::type_name() { return stringDenseVector(); }
/*-------------------------------------------------*/
} // namespace cla3p
/*-------------------------------------------------*/
