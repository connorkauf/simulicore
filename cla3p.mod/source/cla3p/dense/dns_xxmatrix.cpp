...
#if 0
/*-------------------------------------------------*/
#define XxMatrixTmpl XxMatrix2<T_Scalar,T_Matrix>
#define XxMatrixTlst template <typename T_Scalar, typename T_Matrix>
/*-------------------------------------------------*/
XxMatrixTlst
XxMatrixTmpl::XxMatrix2()
{
}
/*-------------------------------------------------*/
XxMatrixTlst
XxMatrixTmpl::XxMatrix2(uint_t nr, uint_t nc, const Property& pr)
	: XxObject2<T_Scalar,T_Matrix>(nr, nc, nr, pr)
{
}
/*-------------------------------------------------*/
XxMatrixTlst
