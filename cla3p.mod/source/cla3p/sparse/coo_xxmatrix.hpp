...
class XxMatrix : public MatrixMeta {
	...
	public:
		...
		XxMatrix(const XxMatrix<T_Int,T_Scalar,T_Matrix>&) = default;
		XxMatrix<T_Int,T_Scalar,T_Matrix>& operator=(const XxMatrix<T_Int,T_Scalar,T_Matrix>&) = default;

		XxMatrix(XxMatrix<T_Int,T_Scalar,T_Matrix>&&) = default;
		XxMatrix<T_Int,T_Scalar,T_Matrix>& operator=(XxMatrix<T_Int,T_Scalar,T_Matrix>&&) = default;
